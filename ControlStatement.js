...
if (userAge >= 18) {
    console.log("You are illegible to drive");
}else {
    console.log("You are not illegible to drive");
}
...
else if (score >= 50 && score <= 59) console.log("E");
...
else if (time >= 16 && time < 18) console.log("Good Evening");
else if (time >= 18 && time <= 24) console.log("Good Night");
